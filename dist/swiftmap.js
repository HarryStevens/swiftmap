// https://github.com/HarryStevens/swiftmap#readme Version 0.2.8. Copyright 2018 Harry Stevens.
(function (global, factory) {
  ...
  function layerUtil(swiftmap, data, key, layer, type){
  ...
  function layerPoints(data, key, layer){
    return layerUtil(this, data, key, layer, "points");
  }
  ...
  function graticule$1(step){
    this.svg.append("path")
      .datum(graticule().step(step && isArray(step) ? step : [10, 10]))
